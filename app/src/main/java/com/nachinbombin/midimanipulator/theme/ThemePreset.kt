...
object ThemePresets {
    ...
    /**
     * FIX: ThemeManager and ThemePickerDialog both reference ThemePresets.all
     * but it was never declared — caused an Unresolved reference compile error.
     * Ordered exactly as per spec: Default first, White Wolf last.
     */
